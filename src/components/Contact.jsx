...
const Contact = () => {
  return (
    <div id = "contact" className="min-h-screen flex flex-col items-center justify-center px-6">
      <h1 className="text-4xl font-extrabold text-white mb-6">Contact Me</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-3xl">
        ...
        />
        <ContactCard
          icon={<FaGithub className="text-blue-400 text-3xl" />}
          title="GitHub"
...
const ContactCard = ({ icon, title, text, link }) => {
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 text-center shadow-lg transition-transform duration-300 hover:scale-105">
